...
public function ListarReporte($table, $codigo)
	{
		try
		{
			$result = array();
			$cadena = "SELECT a.id as idbecario, 
a.nombre as nombrebecario, b.id as idprograma, b.nombre as nombreprograma,
b.pais as paisprograma
  FROM becario a inner join programa b on a.fkprograma = b.id  ";
